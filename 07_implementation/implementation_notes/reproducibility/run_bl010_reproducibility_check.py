...
def build_paths(root: Path) -> dict[str, Path]:
    return {
        ...
        "bl009_script": root / "07_implementation" / "implementation_notes" / "observability" / "build_bl009_observability_log.py",
        ...
        "bl009_log": root / "07_implementation" / "implementation_notes" / "observability" / "outputs" / "bl009_run_observability_log.json",
        "bl009_index": root / "07_implementation" / "implementation_notes" / "observability" / "outputs" / "bl009_run_index.csv",
    }

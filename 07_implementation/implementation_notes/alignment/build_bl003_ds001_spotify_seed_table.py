...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--ds001-candidates",
        type=Path,
        default=repo_root / "07_implementation" / "implementation_notes" / "data_layer" / "outputs" / "ds001_working_candidate_dataset.csv",
    )
    parser.add_argument(
        "--spotify-export-dir",
        type=Path,
        default=repo_root / "07_implementation" / "implementation_notes" / "ingestion" / "outputs" / "spotify_api_export",
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=repo_root / "07_implementation" / "implementation_notes" / "alignment" / "outputs",
    )
    parser.add_argument(

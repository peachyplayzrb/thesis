"""Resolve BL-009 observability controls from payload, run config defaults, and environment values."""
...
def resolve_bl009_runtime_controls() -> dict[str, object]:
    """Resolve BL-009 runtime controls and attach canonical run-config artefact paths when present."""

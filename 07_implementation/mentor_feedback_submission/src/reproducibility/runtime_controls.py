"""Runtime control resolution for BL-010 reproducibility checks."""
...
def _load_bl010_controls_from_env() -> dict[str, object]:
    """Build BL-010 controls from environment defaults and overrides."""
    return {
        "config_source": "environment",
        "run_config_path": None,
        "run_config_schema_version": None,
...
def _sanitize_bl010_controls(controls: dict[str, object]) -> dict[str, object]:
    """Normalize runtime-control payload fields into stable shapes."""
...
def resolve_bl010_runtime_controls() -> dict[str, object]:
    """Resolve BL-010 runtime controls plus run-intent/effective-config paths."""

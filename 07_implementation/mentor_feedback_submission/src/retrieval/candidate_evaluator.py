...
def weighted_lead_genre_similarity(candidate_label: str, profile_weights: dict[str, float]) -> float:
    """Score how well the candidate lead genre lines up with the weighted profile lead-genre mix."""
...
def evaluate_bl005_candidates(
    *,
    ...
    """Evaluate every candidate row against the BL-005 semantic and numeric keep rules."""

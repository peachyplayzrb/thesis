"""Normalize raw listening-history CSV exports into the BL-002 event format.

This parser cleans up the source columns, standardizes timestamps and play-time
fields, and records row-quality flags for anything that looks incomplete.
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input-csv",
        default="test_assets/sample_listening_history.csv",
        help="Path to raw listening-history CSV.",
    )
    parser.add_argument(
        "--output-jsonl",
        default="run_outputs/tc001_normalized_events.jsonl",
        help="Path to normalized event JSONL output.",
    )
    parser.add_argument(
        "--summary-json",
        default="run_outputs/tc001_validation_summary.json",
        help="Path to validation summary JSON output.",
    )
    parser.add_argument(
        "--invalid-rows-csv",
        default="run_outputs/tc001_invalid_rows.csv",

...
| C-197 | 2026-03-28 | Copilot | Code hygiene refactor pass: added `safe_int` to `final_artefact/src/shared_utils/parsing.py`, removed duplicate `_safe_float`/`_safe_int` helpers from `final_artefact/src/playlist/rules.py` and `final_artefact/src/playlist/reporting.py`, removed redundant `normalize_text` wrapper from `final_artefact/src/ingestion/ingest_history_parser.py`; applied safe-cast imports throughout all three modules; 181/181 tests pass; pyright returns 0 errors on all edited files. |

...
_BL013_STABLE_ARTIFACT_RELATIVE_PATHS: Dict[str, str] = {
    "bl004_seed_trace": "bl004_profile/outputs/bl004_seed_trace.csv",
    "bl005_filtered_candidates": "bl005_retrieval/outputs/bl005_filtered_candidates.csv",
    "bl005_candidate_decisions": "bl005_retrieval/outputs/bl005_candidate_decisions.csv",
    "bl006_scored_candidates": "bl006_scoring/outputs/bl006_scored_candidates.csv",
    "bl007_assembly_trace": "bl007_playlist/outputs/bl007_assembly_trace.csv",
}


_BL014_FRESHNESS_INPUT_RELATIVE_PATHS: Dict[str, str] = {
    "bl010_snapshot": "bl010_reproducibility/outputs/bl010_reproducibility_config_snapshot.json",
    "bl010_report": "bl010_reproducibility/outputs/bl010_reproducibility_report.json",
    "bl011_snapshot": "bl011_controllability/outputs/bl011_controllability_config_snapshot.json",
    "bl011_report": "bl011_controllability/outputs/bl011_controllability_report.json",
}
...
def bl013_bl003_script_relpath() -> str:
    ...
    return "bl003_alignment/build_bl003_ds001_spotify_seed_table.py"


def bl013_bl003_summary_relpath() -> str:
    """Relative BL-003 summary path used for seed freshness checks."""
    return "bl003_alignment/outputs/bl003_ds001_spotify_summary.json"
...
def bl014_bl013_latest_summary_path(repo_root: Path) -> Path:
    ...
    return repo_root / "bl013_entrypoint/outputs/bl013_orchestration_run_latest.json"
...
def bl014_pipeline_script_paths(repo_root: Path) -> Dict[str, Path]:
    ...
    return {
        "bl010_script": repo_root / "bl010_reproducibility/run_bl010_reproducibility_check.py",
        "bl011_script": repo_root / "bl011_controllability/run_bl011_controllability_check.py",
        "bl013_script": repo_root / "bl013_entrypoint/run_bl013_pipeline_entrypoint.py",
    }
...
def bl014_refinement_diagnostic_paths(repo_root: Path) -> Dict[str, Path]:
    ...
    return {
        "bl006_distribution": repo_root / "bl006_scoring/outputs/bl006_score_distribution_diagnostics.json",
        "bl007_assembly_report": repo_root / "bl007_playlist/outputs/bl007_assembly_report.json",
    }
...
def bl010_required_paths(repo_root: Path) -> Dict[str, Path]:
    ...
    return {
        "bl004_script": repo_root / "bl004_profile/build_bl004_preference_profile.py",
        "bl005_script": repo_root / "bl005_retrieval/build_bl005_candidate_filter.py",
        "bl006_script": repo_root / "bl006_scoring/build_bl006_scored_candidates.py",
        "bl007_script": repo_root / "bl007_playlist/build_bl007_playlist.py",
        "bl008_script": repo_root / "bl008_transparency/build_bl008_explanation_payloads.py",
        "bl009_script": repo_root / "bl009_observability/build_bl009_observability_log.py",
        "bl004_profile": repo_root / "bl004_profile/outputs/bl004_preference_profile.json",
        "bl004_summary": repo_root / "bl004_profile/outputs/bl004_profile_summary.json",
        "bl004_seed_trace": repo_root / "bl004_profile/outputs/bl004_seed_trace.csv",
        "bl005_filtered": repo_root / "bl005_retrieval/outputs/bl005_filtered_candidates.csv",
        "bl005_decisions": repo_root / "bl005_retrieval/outputs/bl005_candidate_decisions.csv",
        "bl005_diagnostics": repo_root / "bl005_retrieval/outputs/bl005_candidate_diagnostics.json",
        "bl006_scored": repo_root / "bl006_scoring/outputs/bl006_scored_candidates.csv",
        "bl006_summary": repo_root / "bl006_scoring/outputs/bl006_score_summary.json",
        "bl007_playlist": repo_root / "bl007_playlist/outputs/bl007_playlist.json",
        "bl007_trace": repo_root / "bl007_playlist/outputs/bl007_assembly_trace.csv",
        "bl007_report": repo_root / "bl007_playlist/outputs/bl007_assembly_report.json",
        "bl008_payloads": repo_root / "bl008_transparency/outputs/bl008_explanation_payloads.json",
        "bl008_summary": repo_root / "bl008_transparency/outputs/bl008_explanation_summary.json",
        "bl009_log": repo_root / "bl009_observability/outputs/bl009_run_observability_log.json",
        "bl009_index": repo_root / "bl009_observability/outputs/bl009_run_index.csv",
    }
...
def bl009_required_paths(repo_root: Path, bl009_script_path: Path | None = None) -> Dict[str, Path]:
    ...
    script_path = bl009_script_path or (
        repo_root / "bl009_observability/build_bl009_observability_log.py"
    )
    return {
        "bl004_profile": repo_root / "bl004_profile/outputs/bl004_preference_profile.json",
        "bl004_summary": repo_root / "bl004_profile/outputs/bl004_profile_summary.json",

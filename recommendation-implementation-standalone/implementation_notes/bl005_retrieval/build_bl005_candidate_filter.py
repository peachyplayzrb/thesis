...
def resolve_bl005_paths(root: Path) -> dict[str, Path]:
    ...
    seed_trace_path = root / "bl004_profile" / "outputs" / "bl004_seed_trace.csv"
    candidate_path = (
        root / "bl000_data_layer" / "outputs" / "ds001_working_candidate_dataset.csv"
    )
    output_dir = root / "bl005_retrieval" / "outputs"
    return {

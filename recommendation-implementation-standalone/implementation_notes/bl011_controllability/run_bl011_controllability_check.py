...
def build_paths(root: Path) -> dict[str, Path]:
    return {
        ...
        "active_candidates": root / "07_implementation" / "implementation_notes" / "bl000_data_layer" / "outputs" / "ds001_working_candidate_dataset.csv",
        "baseline_snapshot": root / "07_implementation" / "implementation_notes" / "bl010_reproducibility" / "outputs" / "bl010_reproducibility_config_snapshot.json",
        "output_dir": root / "07_implementation" / "implementation_notes" / "bl011_controllability" / "outputs",
    }

...
# Paths
# ---------------------------------------------------------------------------
DEFAULT_SCORED_CSV = Path("bl006_scoring/outputs/bl006_scored_candidates.csv")
DEFAULT_SCORE_SUMMARY_JSON = Path("bl006_scoring/outputs/bl006_score_summary.json")
DEFAULT_PLAYLIST_JSON = Path("bl007_playlist/outputs/bl007_playlist.json")
DEFAULT_TRACE_CSV = Path("bl007_playlist/outputs/bl007_assembly_trace.csv")
DEFAULT_OUTPUT_DIR = Path("bl008_transparency/outputs")
...
def _env_path(name: str, default_relative: Path) -> Path:
    ...
    if raw:
        return Path(raw)
    return impl_root() / default_relative

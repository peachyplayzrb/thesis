...
- **ACTIVE RUNTIME POSTURE:** `07_implementation/` is the canonical active runtime/build target. Treat `_scratch/` as legacy/reference material unless explicitly requested.

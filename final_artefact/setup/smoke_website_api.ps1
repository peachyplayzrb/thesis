...
Assert-True ($config.pipeline.stages.Count -ge 7) "Runtime config missing stage catalog entries."
...
Assert-True ($stageCatalog.stages.Count -eq 7) "Stage catalog should contain 7 stages."

...
from shared_utils.env_utils import env_float, env_int, env_str
from shared_utils.io_utils import open_text_write, sha256_of_file, write_json
...
DEFAULT_SCORED_CANDIDATES_PATH = Path(
    "scoring/outputs/bl006_scored_candidates.csv"
)
...
def main() -> None:
    ...
    report = {
        ...
        "output_artifact_hashes": {
            "playlist.json":       sha256(playlist_path),

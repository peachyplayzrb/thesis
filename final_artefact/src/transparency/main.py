...
from shared_utils.stage_utils import ensure_named_paths_exist, load_required_json
...
def main() -> None:
    ...
    score_summary = load_required_json(score_summary_json, label="BL-006 score summary", stage_label="BL-008")
    ...
    playlist_data = load_required_json(playlist_json, label="BL-007 playlist", stage_label="BL-008")
